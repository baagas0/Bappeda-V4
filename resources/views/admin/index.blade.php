        ...
        <div class="card">
            ...
            <div class="comment-widgets scrollable" style="height:560px;">
                ...
                <div class="d-flex flex-row comment-row m-t-0">
                    <div class="p-2">
                        <img src="{{ asset('backend/assets/images/users/1.jpg') }}" alt="user" width="50" class="rounded-circle">
                    </div>
                ...
                <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                        <img src="{{ asset('backend/assets/images/users/2.jpg') }}" alt="user" width="50" class="rounded-circle">
                    </div>
                ...
                <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                        <img src="{{ asset('backend/assets/images/users/5.jpg') }}" alt="user" width="50" class="rounded-circle">
                    </div>
                    <div class="comment-text w-100">
                ...
                <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                        <img src="{{ asset('backend/assets/images/users/6.jpg') }}" alt="user" width="50" class="rounded-circle">
                    </div>
                    <div class="comment-text w-100">
                        <h6 class="font-medium">James Anderson</h6>
                        <span class="m-b-15 d-block">Lorem Ipsum is simply dummy text of the printing and type setting industry. </span>
