...
<head>
    ...
    <meta name="description" content="CopyRight By Bagas Aditya">
    <meta name="author" content="Bagas Aditya Mahendra">
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('backend/assets/images/favicon.png') }}">
    <title>{{ 'Admin | '.(empty($title) ? 'Null' : $title) }}</title>
    <!-- Custom CSS -->
    ...
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.jsy"></script>
    <script src="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.jsy"></script>
<![endif]-->
</head>
